...
// marvalHeros.push(dcHeros) //It will push Array into array: [ 'thor', 'Ironman', 'spiderman', [ 'Superman', 'flash', 'batman' ] ]
...
// /* Important Note: We can not give "Infinity" in place of depth because this is not a good practice
...
console.log(Array.from("Veeresh"));  //An string to convert to an array. Eg:- ['V', 'e', 'e', 'r', 'e', 's','h']
